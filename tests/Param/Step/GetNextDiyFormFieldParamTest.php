 ...
 * @internal
 */
#[CoversClass(GetNextDiyFormFieldParam::class)]
final class GetNextDiyFormFieldParamTest extends TestCase
{
    public function testParamImplementsRpcParamInterface(): void
    {
        $param = new GetNextDiyFormFieldParam();
    ...
    public function testDefaultValues(): void
    {
        ...
        // 测试显式传递默认值
        $paramWithDefaults = new GetNextDiyFormFieldParam(
            formId: 2,
            recordId: 0
        );
