 ...
 * @internal
 */
#[CoversClass(GetUserFormRecordListParam::class)]
final class GetUserFormRecordListParamTest extends TestCase
{
    public function testParamImplementsPaginatorParamInterface(): void
    {
        $param = new GetUserFormRecordListParam();
    ...
    {
        $param = new GetUserFormRecordListParam(formId: $formId);
    ...
    {
        $param = new GetUserFormRecordListParam(formId: '');
    ...
    {
        $param = new GetUserFormRecordListParam(formId: 'FORM123abc456');
    ...
    public function testParamWithLongFormId(): void
    {
        ...
        $param = new GetUserFormRecordListParam(formId: $longFormId);
    ...
    {
        $param = new GetUserFormRecordListParam(currentPage: $currentPage);
    ...
    {
        $param = new GetUserFormRecordListParam(pageSize: $pageSize);
    ...
    {
        $param = new GetUserFormRecordListParam(lastId: $lastId);
    ...
    public function testDefaultValues(): void
    {
        ...
        // 测试显式传递默认值
        $paramWithDefaults = new GetUserFormRecordListParam(
            formId: null,
            currentPage: 1,
            pageSize: 20,
            lastId: null
