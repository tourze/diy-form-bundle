 ...
 */
#[CoversClass(DiyFormSmsDsnCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DiyFormSmsDsnCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    protected function getControllerService(): DiyFormSmsDsnCrudController
    {
        return self::getService(DiyFormSmsDsnCrudController::class);
    }
