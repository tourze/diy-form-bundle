 ...
 * @internal
 */
#[CoversClass(DiyFormDataCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DiyFormDataCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    protected function getControllerService(): DiyFormDataCrudController
    {
        return self::getService(DiyFormDataCrudController::class);
    }
