...
use DiyFormBundle\Controller\Admin\DiyFormSendLogCrudController;
 ...
 */
#[CoversClass(DiyFormSendLogCrudController::class)]
#[RunTestsInSeparateProcesses]
final class DiyFormSendLogCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    protected function getControllerService(): DiyFormSendLogCrudController
    {
        return self::getService(DiyFormSendLogCrudController::class);
    }
    ...
    public function testGetEntityFqcn(): void
    {
        ...
        self::assertSame(SendLog::class, $fqcn);
    }
